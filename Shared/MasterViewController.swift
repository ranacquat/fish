...
class MasterViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        NotificationCenter.default.addObserver(forName: NSNotification.Name(rawValue: "LOCALIZATION_FAILED"), object: nil, queue: OperationQueue.main, using: {_ in
            let alert = UIAlertController.init(title: "GéoLocalisation impossible", message: "Vous n'avez pas d'accès à Internet", preferredStyle: UIAlertControllerStyle.alert)
            alert.addAction(UIAlertAction.init(title: "OK", style: UIAlertActionStyle.cancel, handler: {_ in
            }))
